...
public class UserResource {
	...
	//esse @GetMapping faz a gente chamar no postman o caminho /users ele retorna todos usarios conforme este metodo
	@GetMapping
	...
	//@GetMapping(value = "/{id}") seu eu chamar no postman o caminho /users e incluir um barra/ com numero de um id de usuario ele retorna aquele usuario especifico do id
	//esses endpoint serve para recuperar dados do banco de dados para inserir usamos o @PostMapping
	@GetMapping(value = "/{id}")
	...
	//endpoin para inserir no banco @PostMapping o endpoint recebe um objeto User obj
	//@RequestBody para Json decerializado para objeto User do java..tem que por o @RequestBody
	@PostMapping
